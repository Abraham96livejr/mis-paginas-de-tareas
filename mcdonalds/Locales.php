...
<h1 class=h1colortitulo>↓Locales De Todos Los Mcdonalds↓</h1>
<br>
	<table>
		<tr>
			<td class=color1>Barrio</td>
			<td class=color1>Direction</td>
			<td class=color1>Jefe</td>
			<td class=color1>n°</td>
			<td class=color1>Id_L</td>
		</tr>
...
?>		
		...
		<tr>
			<td class=color1><?php echo $mostrar['Barrio'] ?></td>
			<td class=color1><?php echo $mostrar['Direction'] ?></td>
			<td class=color1><?php echo $mostrar['Jefe'] ?></td>
			<td class=color1><?php echo $mostrar['n°'] ?></td>
			<td class=color1><?php echo $mostrar['Id_L'] ?></td>
	</tr>
		<?php
		}
		?>
